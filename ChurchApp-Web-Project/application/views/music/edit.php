<section class="content">
    <div class="container-fluid">
        <div class="block-header">
          <h2>Edit Song</h2>
          <small>You can only update song details</small>
        </div>
    <!-- Page content-->
                        ...
                        <div class="body">
                          ...
                          <form id="upload-form">
                            ...
                            <div class="input-group addon-line" style="margin-top:20px;">
                                <label>Song Title (Users can search for this song using this title)</label>
                                <div class="form-line">
                                    <input type="text" class="form-control" id="title" placeholder="Song Title" required="" autofocus="" value="<?php echo $audio->title; ?>">
                                </div>
                            </div>

                            <div class="input-group addon-line">
                               <label>Song Description (Users can search for this song using this description)</label>
                                <div class="form-line">
                                    <textarea type="text" class="form-control" id="description" placeholder="Song Description" required="" autofocus=""><?php echo $audio->description; ?></textarea>
                                </div>
                            </div>

                            <div id="link_div" style="margin-top:20px;">
                              <div class="input-group addon-line" style="margin-top:20px;">
                              ...
                              <div class="input-group addon-line" style="margin-top:20px;">
                                     <label id="video-label">Song File Link</label>

                                  <div class="form-line">
                                      <input type="url" class="form-control" id="media_link" placeholder="Song File Link" autofocus="" value="<?php echo $audio->source; ?>">
                                  </div>
                            ...
                            <div class="input-group addon-line" style="margin-top:20px;">
                                <label>Song Duration (format 00:00:00)</label>
                                <div class="form-line">
                            ...
                            <div class="box-footer text-center">
                               <button id="submit" onclick="updateSong(event)" class="btn btn-primary waves-effect" type="submit">UPDATE SONG</button>
